  ...
  _createClass(FormWithConditionals, [{
    ...
    value: function updateConf(formData, formContext) {
      ...
      return this.runRules(formData, formContext).then(function (conf) {
        ...
        console.log("oldTemplate==new");
        console.log(conf.uiSchema["ui:template"] == thisNew.state.uiSchema["ui:template"]);
        //conf.uiSchema["ui:template"]=thisNew.state.uiSchema["ui:template"]
        //console.log("oldTemplate==new");
        //console.log(conf.uiSchema["ui:template"]==thisNew.state.uiSchema["ui:template"]);
...
FormWithConditionals.propTypes = {
  ...
  validateSchema: _propTypes2.default.bool
};
